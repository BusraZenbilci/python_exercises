...
lst[0 : 4]   # 0., 1., 2. ve 3. indexi alır
...
Muh = ogrenciler[0:3]
for index, student in enumerate(Muh):
    print("Mühendislik Fakültesi ", index+1, " . öğrenci: ", student)

Tıp = ogrenciler[3:6]
for index, student in enumerate(Tıp):
...
ders_bilgileri = list(zip(kredi, ders_kodu, kontenjan))
